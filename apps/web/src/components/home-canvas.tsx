...
const CHATGPT_HOME_SETUP_PROMPT =
  'I need to set up my house for smart devices. Open https://tryportego.com and create a standard 180 m² house with one floor containing a kitchen, living room, two bedrooms, a bathroom, and a common-space room connecting all the other rooms. Add one light to every room except the common space. In the living room, add a second light named "TV lamp." Remember to add appropriate doors and windows. The website exposes tools through WebMCP; use those tools to make the changes.';
